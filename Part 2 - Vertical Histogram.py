...
retriever = []
exclude = []
progression_table = [progress,trailer,retriever,exclude]
total_outcomes = 0
...
def histogram_table(progression_table):   # printing the histogram table base on that
    ...
    for i in range(total_outcomes):
        for y in progression_table:      
            if len(y) > 0:
                print("    ", "*","    ", end="  ")
                y.pop() 
            else: 
                print("    ", " ","    ", end="  ")
        print()        #according to the user input credit level printing the vertical histrogram  with "=" mark


def staff_histogram(): # printing the vertical histogram  base on that
    print("\n")
    print("=" * 80)    # print "=" mark
    print("Vertical Histogram\n")
    histogram_table(progression_table)
    print("\n")
